...
PROFILE = {
    ...
    'VOICE_INTERFACE': 'Выберите голосовую маску:',
    'BUTTONS': {
        'Сменить маску голоса': 'voice_mask_main',
        '‹ Назад': 'home'
    },
    'VOICE': {
        'Артемий Лебедев': 'voice_mask_3',
        'Женский голос': 'voice_mask_0',
        '‹ Назад': 'profile'
    }
}
